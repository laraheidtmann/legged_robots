...
q_actuated_home[:6] = np.array([0.0, 0.0, -0.44, 0.90, -0.46, 0.0])
q_actuated_home[6:12] = np.array([0.0, 0.0, -0.44, 0.90, -0.46, 0.0])
q_actuated_home[14:21]= np.array([0,-0.24, 0, -1, 0,0,0]) #left arm
q_actuated_home[21:28]= np.array([0,-0.24, 0, -1, 0,0,0]) # right arm
